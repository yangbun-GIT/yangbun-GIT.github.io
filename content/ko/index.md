    ...
    content:
      ...
      text: |
        <div style="text-align:center;">
          <img src="/ko/authors/admin/avatar.jpg" alt="프로필 이미지" style="width:96px; border-radius:50%; margin-bottom:18px;" />

          <div style="font-size:1.5em; font-weight:bold; margin-bottom:7px;">윤영준</div>
          <div style="font-size:1em; margin-bottom:8px; color:#bfc6d1;">
          ...
          <div style="margin-bottom:12px;">
            <a href="mailto:yang_bun@jbnu.ac.kr" style="margin:0 8px;"><i class="fas fa-envelope"></i></a>
            <a href="https://github.com/yangbun-GIT" style="margin:0 8px;"><i class="fab fa-github"></i></a>
            <a href="https://x.com/" style="margin:0 8px;"><i class="fab fa-x-twitter"></i></a>
            <a href="https://kr.linkedin.com/" style="margin:0 8px;"><i class="fab fa-linkedin"></i></a>
            <a href="https://www.instagram.com/0_jun_03/" style="margin:0 8px;"><i class="fab fa-instagram"></i></a>
          </div>
